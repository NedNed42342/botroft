...
class Owner:
    ...
    async def info(self):
        ...
        red_repo = author_repo + "/Bot-DiscordBot"
        ...
        about = (
            "This is an instance of [Bot, an open source Discord bot]({}) "
            "created by [Twentysix]({}) and improved by many.\n\n"
            "Bot is backed by a passionate community who contributes and "
        ...
        embed.add_field(name="About Bot", value=about, inline=False)
    ...
    def _get_version(self):
        if not os.path.isdir(".git"):
            msg = "This instance of Bot hasn't been installed with git."
